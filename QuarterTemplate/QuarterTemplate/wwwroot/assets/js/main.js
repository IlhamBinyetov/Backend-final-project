...
(function($) {
  "use strict";
    ...
    $(document).on("click", ".favorite", function (e) {
        ...
        fetch('https://localhost:44388/product/addtofavorites/' + id)
    ...
    $(document).on("click", ".deleteFav", function (e) {
        ...
        fetch('https://localhost:44388/product/deletefavorites/' + id)
            .then(response => response.text())
            .then(data => {
    ...
    $(document).on("click", ".product-modal", function (e) {
        ...
        fetch('https://localhost:44388/home/getproduct/' + id)
            .then(response => response.text())
            .then(data => {
