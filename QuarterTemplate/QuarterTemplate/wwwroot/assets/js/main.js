...
(function($) {
  "use strict";
    ...
    $(document).on("click", ".favorite", function (e) {
        ...
        fetch('https://localhost:44388/home/addproduct/' + id)
            .then(response => response.text())
            .then(data => {
                //$("#quickModal .product-title").text(data.name)
                //$("#quickModal .genre-name").text(data.genre.name)
                ...
                //                        <li>Genre: <a href="#" class="list-value font-weight-bold genre-name"> Canon</a></li>
